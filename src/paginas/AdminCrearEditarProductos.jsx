  ...
  const handleClickFormCrearProducto = async (ev) => {
    ...
    if (nombre && precio && descripcion && imagen) {
      try {
        ...
        const res = await clienteAxios.post("/productos", formData, configHeaderImagen)
        ...
        <Form className='w-25'>
          <Form.Group className="mb-3" controlId="nombre">
            ...
            <Form.Control type="text" name='nombre'
              value={formCrearProducto.nombre} onChange={handleChangeFormCrearProducto} />
          </Form.Group>
          <Form.Group className="mb-3" controlId="precio">
            <Form.Label>Precio</Form.Label>
            <Form.Control type="number" name='precio'
              value={formCrearProducto.precio} onChange={handleChangeFormCrearProducto} />
          </Form.Group>
          <Form.Group className="mb-3" controlId="descripcion">
            <Form.Label>Descripcion</Form.Label>
            <Form.Control type="text" name='descripcion'
              value={formCrearProducto.descripcion} onChange={handleChangeFormCrearProducto} />
          </Form.Group>
          {
            !id && (
