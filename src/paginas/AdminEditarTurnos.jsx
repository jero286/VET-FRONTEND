...
const AdminEditarTurnos = () => {
    ...
    useEffect(() => {
        const obtenerTurno = async () => {
            try {
                const respuesta = await clienteAxios.get(`/turnos/${id}`, configHeader);
    ...
    const handleActualizarTurno = async (ev) => {
        ...
        if (Object.keys(erroresTurnos).length === 0) {
            try {
                const actualizar = await clienteAxios.put(
                    `/turnos/${id}`,
                    turnos,
                    configHeader
                );
                ...
                <Form onSubmit={handleActualizarTurno}>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            ...
                            className={errores.detalle ? "form-control is-invalid" : "form-control"}
                        />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            ...
                            onChange={handleOnChangeDatosFormulario}
                            className={errores.veterinario ? "form-control is-invalid" : "form-control"}
                        />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            ...
                            onChange={handleOnChangeDatosFormulario}
                            className={errores.mascota ? "form-control is-invalid" : "form-control"}
                        />
                    </Form.Group>
